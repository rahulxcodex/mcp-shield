  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-[#090a0f]/85 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden lg:flex items-center gap-3.5 xl:gap-6 text-xs xl:text-sm font-medium text-slate-300 whitespace-nowrap shrink-0">
        ...
        <div className="hidden sm:flex items-center gap-2 lg:gap-3 shrink-0">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white hover:border-slate-700 transition shrink-0"
          >
      ...
      {/* Mobile dropdown */}
      {mobileOpen && (
        <div className="lg:hidden border-b border-slate-800 bg-[#0c0e17] px-4 py-4 space-y-3 text-sm">
          <a
            href="#features"
